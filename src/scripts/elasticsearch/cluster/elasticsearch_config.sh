...
elasticsearch_home=/opt/module/elasticsearch-7.11.1
...
sed -i "s/## -Xms4g/-Xms512m/g" $elasticsearch_home/config/jvm.options
sed -i "s/## -Xmx4g/-Xmx512m/g" $elasticsearch_home/config/jvm.options
